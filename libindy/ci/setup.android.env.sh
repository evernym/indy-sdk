...
download_and_setup_toolchain(){
    if [ "$(uname)" == "Darwin" ]; then
        ...
        download_and_unzip_if_missed "android-ndk-r19c" "https://dl.google.com/android/repository/" "android-ndk-r19c-darwin-x86_64.zip"
        popd
        ...
        download_and_unzip_if_missed "android-ndk-r19c" "https://dl.google.com/android/repository/" "android-ndk-r19c-linux-x86_64.zip"
        popd
    fi
