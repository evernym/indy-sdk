...
# libindy 1.8.2 stable
# libnullpay 1.8.2 stable
# libsovtoken 0.9.6~-.1.126 stable
# libvcx 0.2.39277498-fe8a908
...
through to the libvcx shared library.
  ...
  s.source           = { :http => 'https://repo.corp.evernym.com/filely/ios/vcx.libvcxpartial_0.2.39277498-fe8a908_universal.zip' }
